...
const Specials = (props) => {
  return (
    <>
      <section className="bg-white grid mx-0 lg:grid-rows-4 pt-2 w-3/4 lg:w-full rounded-lg place-self-center text-customBlue font-medium duration-500  transition-transform transform cursor-pointer h-[40rem] hover:-translate-x-4 mb-20">
