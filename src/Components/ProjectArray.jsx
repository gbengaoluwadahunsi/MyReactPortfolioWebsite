const MenuArray = [
  {
    ...
    menu: "Pizzon",
    description:
      "A fullstack Pizza ordering  web app,customers can order pizza, made payment and the Admin too can view and edit orders.",
...

  {
    ...
    menu: "Countria",
    description:
      "Get information about countries and weather data via light-speed APIs for every location on the planet.",
...

  {
    ...
    menu: "Motiva",
    description:
      "Look up Motivational quotes, retrieve based on keyword or author, create custom designs on shirts/share on social media.",
...

  {
    ...
    menu: "DropImagery",
    description:
      " Web app to view/save some amazing images by different photographers;login details: user@example.com and 1password.",
    stack: "HTML5, CSS3, JavaScript,Tailwind CSS React.js, Firebase",
    linked: "https://drop-imagery.netlify.app/",
    gitHubRepo:
      "https://github.com/gbengaoluwadahunsi/Drag-and-drop-Image-Gallery",
  },

  {
    ...
    menu: "Tasty Yumzie",
    description:
      " Food restaurant web application, book reservations, order for food and drinks, it also showcases a menu list for each day.",
  ...
  },
  {
    ...
    description:
      "This is my portfolio website where I showcase the projects that I have developed and pushed to production.",
  ...
  },
  {
    ...
    description:
      "Makeup and Beauty web application, this was the first project I did when I started out as a software developer.",
